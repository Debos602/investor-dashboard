...
const LoginPage = () => {
    const [phoneNumber, setPhoneNumber] = useState(""); // Changed to empty string
    ...
    // Modified to not use formatting
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            // Using the raw phone number directly
                    ...
                    >
                        <Box sx={{ mb: 3 }}>
                            ...
                            <StyledTextField
                                ...
                                inputProps={{
                                    autoComplete: "tel",
                                    inputMode: "numeric", // Better for iOS numeric keyboard
                                }}
                            />
                        </Box>
