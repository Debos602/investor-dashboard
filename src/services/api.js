...
const api = axios.create({
    baseURL:
        "https://investment-calculator-backend.dev.quantumos.ai/api-docs/api",
    headers: {
...
export const getCalculationSingle = async (contactId) => {
    try {
        const response = await api.get(`/contacts/${contactId}/calculations`);
        return response.data;
    } catch (error) {
        console.error("Error fetching contact:", error);
        throw error;
...
export const getQuestionSingle = async (contactId) => {
    try {
        const response = await api.get(`/contacts/${contactId}/questionnaires`);
        return response.data;
    } catch (error) {
        console.error("Error fetching contact:", error);
        throw error;
...
export const getVideoSingle = async (contactId) => {
    try {
        const response = await api.get(`/feedbacks/contacts/${contactId}`);
        return response.data;
    } catch (error) {
        console.error("Error fetching contact:", error);
        throw error;
